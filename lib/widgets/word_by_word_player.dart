...
class WordByWordPlayer extends StatefulWidget {
  final String text;
  final VoidCallback onClose;
  
  const WordByWordPlayer({
    super.key,
    required this.text,
  ...
  @override
  State<WordByWordPlayer> createState() => _WordByWordPlayerState();
}

class _WordByWordPlayerState extends State<WordByWordPlayer> {
